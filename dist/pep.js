...
;(function() {
   ...
   function x(e, t) {
      ...
      var r = S(t)
      var i = null
      while (n.length > 0 && n[0] == r.shift()) i = n.shift()
      return i
   }
   function T(e, t, n) {
      var r = x(e, t)
   ...
   var u = function(e, t, s, o, u) {
      ...
      if (a.offsetX === undefined) {
         if (e.offsetX !== undefined) {
            if (Object && Object.defineProperty !== undefined) {
               Object.defineProperty(a, 'offsetX', { writable: true })
               Object.defineProperty(a, 'offsetY', { writable: true })
            }
            a.offsetX = e.offsetX
            a.offsetY = e.offsetY
      ...
      if (e.isPrimary !== undefined) a.isPrimary = e.isPrimary
      else a.isPrimary = true
      if (e.pressure) a.pressure = e.pressure
      else {
         var f = 0
         if (e.which !== undefined) f = e.which
         else if (e.button !== undefined) {
            f = e.button
         }
         a.pressure = f == 0 ? 0 : 0.5
      }
      if (e.rotation) a.rotation = e.rotation
      else a.rotation = 0
      if (e.hwTimestamp) a.hwTimestamp = e.hwTimestamp
      else a.hwTimestamp = 0
      if (e.tiltX) a.tiltX = e.tiltX
      else a.tiltX = 0
      if (e.tiltY) a.tiltY = e.tiltY
      else a.tiltY = 0
   ...
   var l = function(e, t) {
      return (
         e.__handjsGlobalRegisteredEvents && e.__handjsGlobalRegisteredEvents[t]
      )
   }
   var c = function(e, t) {
      while (e && !l(e, t)) e = e.parentNode
      if (e) return e
      else if (l(window, t)) return window
   }
         ...
         if (window.ontouchstart !== undefined) {
            ...
            window.addEventListener('touchmove', function(e) {
               for (var t = 0; t < e.changedTouches.length; ++t) {
                  ...
                  if (i && o(i) === true) e.preventDefault()
